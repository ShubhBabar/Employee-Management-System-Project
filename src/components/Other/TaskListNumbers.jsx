...
const TaskListNumbers = ({ data }) => {
  return (
    <div className="flex flex-wrap mt-10 justify-between gap-5">
      <div className="rounded-xl w-full sm:w-[48%] md:w-[45%] lg:w-[22%] py-6 px-9 bg-blue-400">
        <h2 className="text-3xl font-bold">{data.taskCounts.newTask}</h2>
        <h3 className="text-xl mt-0.5 font-medium">New Task</h3>
      </div>
      <div className="rounded-xl w-full sm:w-[48%] md:w-[45%] lg:w-[22%] py-6 px-9 bg-green-400">
        <h2 className="text-3xl font-bold">{data.taskCounts.completed}</h2>
        <h3 className="text-xl mt-0.5 font-medium">Completed Task</h3>
      </div>
      <div className="rounded-xl w-full sm:w-[48%] md:w-[45%] lg:w-[22%] py-6 px-9 bg-yellow-400">
      ...
      <div className="rounded-xl w-full sm:w-[48%] md:w-[45%] lg:w-[22%] py-6 px-9 bg-red-400">
